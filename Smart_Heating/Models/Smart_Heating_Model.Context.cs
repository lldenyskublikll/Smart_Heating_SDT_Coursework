...
namespace Smart_Heating.Models
{
    ...
    public partial class SMART_HEATINGEntities : DbContext
    {
        public SMART_HEATINGEntities()
            : base("name=SMART_HEATINGEntities")
        {
        }
        ...
        public virtual DbSet<Indicators_List_View> Indicators_List_View { get; set; }
        public virtual DbSet<Maintenance_List_AdminView> Maintenance_List_AdminView { get; set; }
