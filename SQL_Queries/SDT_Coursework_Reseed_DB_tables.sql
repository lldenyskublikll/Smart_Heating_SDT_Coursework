...
DBCC CHECKIDENT ('PersonData', RESEED, 0);
DBCC CHECKIDENT ('Users', RESEED, 0);
DBCC CHECKIDENT ('OMS_Participants', RESEED, 0);
DBCC CHECKIDENT ('ORS_Participants', RESEED, 0);
DBCC CHECKIDENT ('OSBB_Participants', RESEED, 0);
